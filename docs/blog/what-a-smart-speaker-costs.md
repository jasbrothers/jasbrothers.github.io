...
<p style="text-align:center;margin:1.6em 0"><img src="../images/speaker-solid.svg" alt="The Jas Bros smart speaker: a printed case with a speaker grille, the JAS BROS wordmark, side vents and two microphone ports in the top, with a speech bubble saying Hey Claude pointing at one of the ports" style="max-width:380px;width:100%;height:auto"></p>
